    ...
    return (
        <div>
            <div className="lg:flex lg:justify-between border-b-2 border-gray-950 lg:pb-4 pb-2">
                <p className="lg:text-3xl font-semibold">Machine Learning</p>
                <Link href="machine">
                    <button className=" hidden lg:block px-3 py-2 rounded text-white bg-sky-700">Check All</button>
                </Link>
            </div>
            <div className="lg:grid-cols-3 gap-2 lg:grid">
                ...
                <div className="mt-5 lg:p-2 p-2 lg:w-[360px] shadow">
                    <Image className="lg:h-[200px] lg:w-[350px]"
                           src="https://source.unsplash.com/random/1200x700?MachineLearning" alt="" height={1000} width={1000}/>
